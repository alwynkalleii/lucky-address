...
import { getMasterKeyFromSeed, derivePath } from '../src/hdkey/slip10';
...
describe('SLIP-10 Test Vectors', () => {
  describe('secp256k1 - Vector 1', () => {
    ...
    it('should derive correctly for chain m', async () => {
      ...
      expect(bytesToHex(root.key)).toBe('e8f32e723decf4051aefac8e2c93c9c5b214313817cdb01a1494b917c8436b35');
    ...
    it("should derive correctly for chain m/0'", async () => {
      ...
      expect(bytesToHex(child.key)).toBe('edb2e14f9ee77d26dd93b4ecede8d16ed408ce149b6cd80b0715a2d911a0afea');
  ...
  describe('nist256p1 - Vector 1', () => {
    ...
    it('should derive correctly for chain m', async () => {
      ...
      expect(bytesToHex(root.key)).toBe('612091aaa12e22dd2abef664f8a01a82cae99ad7441b7ef8110424915c268bc2');
    ...
    it("should derive correctly for chain m/0'", async () => {
      ...
      expect(bytesToHex(child.key)).toBe('6939694369114c67917a182c59ddb8cafc3004e63ca5d3b84403ba8613debc0c');
  ...
  describe('ed25519 - Vector 1', () => {
    ...
    it('should derive correctly for chain m', async () => {
      ...
      expect(bytesToHex(root.key)).toBe('2b4be7f19ee27bbf30c667b642d5f4aa69fd169872f8fc3059c08ebae2eb19e7');
    ...
    it("should derive correctly for chain m/0'", async () => {
      ...
      expect(bytesToHex(child.key)).toBe('68e0fe46dfb67e368c75379acec591dad19df3cde26e63b93a8e704f1dade7a3');
